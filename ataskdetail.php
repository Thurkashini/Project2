					...
					<div class="col-auto"> 
						...
						<table class="table table-bordered table-striped text-center">
								...
								<tr>
									...
									<?php  
										...
										if (!$conn){
											...
											$sql="UPDATE user SET finish='$conform'";
											
											if(mysqli_query($conn,$sql)){
												//echo"New record created successfully";
												header:("Location: http://localhost/Project2/home.html");
												exit;
											}else{
								...
								<tr>
									...
									<td><input type="text" class="form-control" id="confrom" placeholder="yes/no" class="form-control" name="confrom"></td>
								
									<td><button type="Submit" value="Submit">finish</button></td>
								</tr>
